  ...
  education: {
    ...
    awards: {
      ...
      zh: [
        ...
        { label: "2024-25 院长荣誉录", image: "deans-list-2024" },
    ...
    languages: {
      en: [
        ...
        { name: "English", level: "Proficient; TOEFL 6.0, IELTS 8.0, CET-4 660, with A-range grades across all English-related courses" },
        { name: "Japanese", level: "Basic" },
        { name: "Spanish", level: "Basic, CEFR: B1" },
      ],
      zh: [
        { name: "普通话", level: "母语" },
        { name: "英语", level: "熟练；托福 6.0，雅思 8.0，大学英语四级 660 分，英语相关课程均 A range" },
        { name: "日语", level: "基础" },
...
export const WORKFLOWS: WorkflowData[] = [
  ...
  {
    cols: 4, rows: 3, variant: "deal-room",
    center: {
      label: { en: "DEAL ROOM", zh: "投资决策室" },
      meta: { en: "Four-source research synthesis", zh: "四源研究综合" },
    },
    nodes: [
      { id: "market", label: { en: "Primary-market Intelligence", zh: "一级市场情报" }, type: "process", col: 0, row: 0 },
      { id: "thematic", label: { en: "Thematic Research", zh: "赛道专题研究" }, type: "process", col: 1, row: 0 },
      { id: "interviews", label: { en: "GP & Expert Interviews", zh: "GP 与专家访谈" }, type: "process", col: 2, row: 0 },
      { id: "sentiment", label: { en: "Sentiment & Investor Q&A", zh: "舆情与投资者问答" }, type: "process", col: 3, row: 0 },
      { id: "synthesis", label: { en: "LLM Transcription & Synthesis", zh: "LLM 转录与综合" }, type: "process", col: 1, row: 1 },
      { id: "landscape", label: { en: "Competitive Landscape", zh: "竞争格局研判" }, type: "process", col: 2, row: 1 },
      { id: "memo", label: { en: "Investment Memo", zh: "投资备忘录" }, type: "process", col: 2, row: 2 },
    ],
    edges: [
      { from: "market", to: "memo" },
      { from: "thematic", to: "landscape" },
      { from: "interviews", to: "synthesis" },
      { from: "sentiment", to: "synthesis" },
      { from: "synthesis", to: "memo" },
      { from: "landscape", to: "memo" },
    ],
  },
